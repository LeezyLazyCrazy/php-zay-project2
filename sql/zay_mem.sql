...
INSERT INTO `zay_mem` (`ZAY_mem_idx`, `ZAY_mem_id`, `ZAY_mem_pass`, `ZAY_mem_pf`, `ZAY_mem_name`, `ZAY_mem_email`, `ZAY_mem_regi_day`) VALUES
(1, 'yabbi', 'aa', 'IMG_2654.png', '누렁이', 'aa', '2021-07-13'),
(2, '누렁이', 'aa', 'IMG_2654.png', '이야삐', 'aa', '2021-07-13');
...
--
ALTER TABLE `zay_mem`
  MODIFY `ZAY_mem_idx` int(11) NOT NULL AUTO_INCREMENT COMMENT '고유번호', AUTO_INCREMENT=3;
COMMIT;
